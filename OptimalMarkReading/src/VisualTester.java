...
public class VisualTester extends PApplet {
	...
	public void draw() {
		...
		if (images.size() > 0) {
			...
			//OpticalMarkReader.threshold(current_image,100);
			//current_image = OpticalMarkReader.subtract(current_image, images.get(0));
			if(OpticalMarkReader.isBubbled(current_image, 800, 200, 100, 200, 0)) {
